...
var ReactDashboardLayout = function (_React$Component) {
  ...
  ReactDashboardLayout.prototype.render = function render() {
    ...
    if (!this.mounted) {
      return _react2.default.createElement('div', { ref: this.myRef, style: { width: '100%', height: '100%' } });
    }
    ...
    var children = _react2.default.Children.map(this.props.children, function (child, i) {
      ...
      });return _react2.default.cloneElement(child, { style: style, key: 'child-' + i });
    });
...
exports.default = ReactDashboardLayout;
